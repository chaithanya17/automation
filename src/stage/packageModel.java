...
public class packageModel {
  ...
  public void orderReviewScreen(){
	  WebElement reviewtext = driver.findElement(By.xpath("//label[contains(text(),'Your Requirement')]"));
		Assert.assertEquals(reviewtext.getText().contains("Your Requirement"), true); 
